    ...
    <form action="{{ route('staff.users.store') }}" method="POST">
        ...
        <div class="grid grid-cols-6 gap-6">
            <div class="col-span-full">
                ...
                <input type="email" name="email" id="email" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" placeholder="myemail@example.com" value="{{ old('email', request()->email) }}" required>
                @error('email')
            ...
            <div class="col-span-full">
                ...
                <input type="text" name="name" id="name" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" placeholder="MyUsername" value="{{ old('name') }}" required>
                @error('name')
                <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
            ...
            <div class="col-span-full">
                ...
                <input type="text" disabled id="temporary_password" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $temporaryPassword }}" required>
            ...
            <div class="col-span-full md:col-span-full">
                ...
                <select id="role_id" name="role_id" class="text-gray-300 bg-gray-700 mt-1 block w-full py-2 px-3 border border-gray-600 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark md:text-sm" required>
