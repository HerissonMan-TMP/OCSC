...
<div class="px-4 py-5 md:p-6 bg-gray-800 rounded-md shadow overflow-hidden">
    <div class="mb-10 flex justify-between items-center">
        <h3 class="font-bold text-2xl text-gray-300">Recruitment #{{ $recruitment->id }} - Applications for <span style="color: {{ $recruitment->role->color }}">{{ $recruitment->role->name }}</span></h3>
