...
@section('title', 'Add a picture - Gallery - Staff')

@section('breadcrumb', 'Staff - Gallery - Add a picture')

@section('content-staff')
    <div class="px-4 py-5 md:p-6 bg-gray-800 rounded-md shadow overflow-hidden">

        <h3 class="mt-2 mb-10 font-bold text-2xl text-gray-300">Add a picture</h3>
        ...
        <form action="{{ route('staff.pictures.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-full">
                    ...
                    <div id="picture_file_box" class="mt-1 flex justify-center py-12 border-2 border-gray-300 border-dashed rounded-md bg-gray-900 bg-cover bg-center">
                ...
                <div class="col-span-full md:col-span-3">
                    ...
                    <input type="text" name="name" id="name" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ old('name') }}">
                    @error('name')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-3">
                    ...
                    <input type="text" name="description" id="description" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ old('description') }}">
                    @error('description')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
