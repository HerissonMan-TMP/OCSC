                                ...
                                <div id="recruitment-dropdown-content" class="hidden absolute z-10 -ml-4 pt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div class="relative grid gap-6 bg-gray-700 px-5 py-6 sm:gap-8 sm:p-8">
                                            ...
                                            <a @if($role->recruitments->isNotEmpty()) href="{{ route('recruitments.show', $role->recruitments->first()) }}" @endif class="@if($role->recruitments->isEmpty()) select-none @endif transition duration-200 -m-3 p-3 flex items-start rounded-lg hover:bg-gray-800">
                                        ...
                                        <div class="px-5 py-5 bg-gray-800 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                                            <div class="flow-root">
                                                <a href="{{ route('global-requirements') }}" class="transition duration-200 -m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-300 hover:bg-gray-900">
