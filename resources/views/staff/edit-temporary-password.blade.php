        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-full md:col-span-2">
                ...
                <div class="col-span-full">
                    <label for="password_confirm" class="block text-sm font-medium text-gray-300">Confirm New password <span class="text-red-500 font-bold">*</span></label>
                    <input type="password" name="password_confirm" id="password_confirm" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm sm:text-sm border-gray-600 rounded-md" required>
                </div>
