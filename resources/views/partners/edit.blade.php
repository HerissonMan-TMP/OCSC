        ...
        <form action="{{ route('staff.partners.update', $partner) }}" method="POST">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-full md:col-span-3">
                    ...
                    <input type="text" name="logo" id="logo-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('logo') ?? $partner->logo }}">
                    @error('logo')
                        <span class="pt-2 text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <select name="category_id" id="category-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md">
                        @foreach($partnerCategories as $category)
                            <option value="{{ $category->id }}" @if($category->id ===  $partner->category_id) selected @endif class="capitalize">{{ $category->name }}</option>
                        @endforeach
                    </select>
                    @error('category_id')
                        <span class="pt-2 text-sm text-red-500">{{ $message }}</span>
                ...
                <div class="col-span-full">
                    ...
                    <input type="text" name="truckersmp_link" id="truckersmp-link-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('truckersmp_link') ?? $partner->truckersmp_link }}">
                ...
                <div class="col-span-full">
                    ...
                    <input type="text" name="trucksbook_link" id="trucksbook-link-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('trucksbook_link') ?? $partner->trucksbook_link }}">
                ...
                <div class="col-span-full">
                    ...
                    <input type="text" name="website_link" id="website-link-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('website_link') ?? $partner->website_link }}">
                    @error('website_link')
                        <span class="pt-2 text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <input type="text" name="twitter_link" id="twitter-link-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('twitter_link') ?? $partner->twitter_link }}">
                    @error('twitter_link')
                        <span class="pt-2 text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <input type="text" name="instagram_link" id="instagram-link-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('instagram_link') ?? $partner->instagram_link }}">
