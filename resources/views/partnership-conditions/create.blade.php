...
@section('title', 'Partnership Conditions & Info - Partners - Staff')

@section('content-staff')
    <div>
        <div class="mb-20 break-words text-center">
            <h2>Partners <span class="font-light">/ Partnership Conditions & Info</span></h2>
        </div>

        <div class="my-4 p-4 rounded-md bg-blue-500 text-sm">
            <i class="fas fa-info-circle fa-fw"></i>
            A new version of the partnership conditions & information is created everytime you change it, which means that the previous versions are saved.
        </div>

        <form action="{{ route('staff.partnership-conditions.store') }}" method="POST">
            @csrf

            <label for="partnership-conditions-input" class="block text-sm font-medium text-gray-300">Partnership Conditions & Info <span class="text-red-500 font-bold">*</span> <i class="ml-1 flex-shrink-0 fab fa-markdown fa-fw"></i></label>
