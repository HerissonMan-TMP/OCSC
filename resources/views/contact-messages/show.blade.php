...
<div class="px-4 py-5 md:p-6 bg-gray-800 rounded-md shadow overflow-hidden">
    ...
    <div class="grid grid-cols-6 gap-6">
        <div class="col-span-full md:col-span-3">
            ...
            <input type="text" disabled id="truckersmp_id" class="text-gray-300 bg-gray-700 font-bold uppercase mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $contactMessage->truckersmp_id }}">
        </div>

        <div class="col-span-full md:col-span-3">
            <label for="vtc" class="block text-sm font-medium text-gray-300">VTC</label>
            <input type="text" disabled id="vtc" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $contactMessage->vtc }}">
        </div>
        ...
        <div class="col-span-full md:col-span-full">
            ...
            <select id="category" disabled class="text-gray-300 bg-gray-700 mt-1 block w-full py-2 px-3 border border-gray-600 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark md:text-sm">
        ...
        <div class="col-span-full md:col-span-3">
            ...
            <input type="text" disabled id="discord" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $contactMessage->discord }}">
        </div>

        <div class="col-span-full md:col-span-3">
            <label for="email" class="block text-sm font-medium text-gray-300">Email address</label>
            <input type="email" disabled id="email" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $contactMessage->email }}">
        </div>

        <div class="col-span-full">
            <label for="message" class="block text-sm font-medium text-gray-300">Message <span class="text-red-500 font-bold">*</span></label>
            <textarea disabled id="message" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" cols="30" rows="8">{{ $contactMessage->message }}</textarea>
        </div>
    </div>
