    ...
    <div>
        ...
        <form action="{{ route('staff.convoy-rules.store') }}" method="POST">
            ...
            <div class="mt-6 text-right">
                <button type="submit" class="w-full md:w-auto transition duration-200 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-bold rounded-md text-gray-700 bg-primary hover:text-gray-700 hover:bg-primary-dark focus:outline-none">Edit the convoy rules</button>
            </div>
        </form>
    </div>
@endsection
