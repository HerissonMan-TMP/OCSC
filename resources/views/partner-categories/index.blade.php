                ...
                <form action="{{ route('staff.partner-categories.store') }}" method="POST">
                    ...
                    <div class="mb-5 grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <input type="text" name="description" id="description-field" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('description') }}" required>
                            @error('description')
                                <span class="pt-2 text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
