        ...
        <div class="shadow overflow-hidden rounded-md">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-full">
                    ...
                    <textarea name="note" id="note" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" cols="30" rows="3">{{ old('note') }}</textarea>
                    @error('note')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
