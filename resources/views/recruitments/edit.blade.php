    ...
    <form action="{{ route('staff.recruitments.update', $recruitment) }}" method="POST" class="mb-10">
        ...
        <div class="grid grid-cols-6 gap-6">
            <div class="col-span-full md:col-span-3">
                ...
                <input type="text" disabled style="color: {{ $recruitment->user->roles->first()->color }}" class="text-gray-300 bg-gray-700 font-bold mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" value="{{ $recruitment->user->name }}">
            </div>
            ...
            <div class="col-span-full md:col-span-full">
                ...
                <select id="role_id" disabled style="color: {{ $recruitment->role->color }}" class="text-gray-300 bg-gray-700 mt-1 block w-full py-2 px-3 border border-gray-600 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark md:text-sm" required>
            ...
            <div class="col-span-full">
                ...
                <textarea name="note" id="note" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" cols="30" rows="3">{{ $recruitment->note }}</textarea>
                @error('note')
                <span class="pt-2 text-sm text-red-500">
                    {{ $message }}
                </span>
        ...
        <div>
            ...
            <form action="{{ route('staff.recruitments.questions.store', $recruitment) }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-full md:col-span-2 flex flex-col justify-center">
                        <input type="text" name="name" class="text-gray-300 bg-gray-700 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" placeholder="Question" maxlength="60">
                        @error('name')
                        <div class="block md:hidden pt-2 text-sm text-red-500">
                            {{ $message }}
                        </div>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-full md:col-span-1 flex flex-col justify-center">
                        <select name="type" class="text-gray-300 bg-gray-700 mt-1 block w-full py-2 px-3 border border-gray-600 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark md:text-sm">
                            <option value="inline">Inline input</option>
                            <option value="multiline">Multiline input</option>
                        </select>
                        @error('type')
                        <div class="block md:hidden block pt-2 text-sm text-red-500">
                            {{ $message }}
                        </div>
                        @enderror
                    </div>
            ...
            <div class="mt-10 md:mt-2 grid grid-cols-8 gap-4 md:gap-6">
                <form action="{{ route('staff.recruitments.questions.update', [$recruitment, $question]) }}" method="POST" class="col-span-full md:col-span-7">
                    ...
                    <div class="grid grid-cols-8 gap-4 md:gap-6 mt-2">
                        ...
                        <div class="col-span-full md:col-span-2 flex flex-col justify-center">
                            <input type="text" name="name" class="text-gray-300 bg-gray-700 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" placeholder="Question" value="{{ $question->name }}" maxlength="60">
                        </div>
