        ...
        <div>
            <ul class="mt-10 mb-20">
                ...
                <li>
                    ...
                    <button id="button-edit-download-{{ $download->id }}" class="transition duration-200 text-primary hover:text-primary-dark focus:outline-none">
                        Edit
            ...
            <form action="{{ route('staff.downloads.store') }}" method="POST">
                ...
                <div class="mb-5 grid grid-cols-6 gap-6">
                    <div class="col-span-full md:col-span-2">
                        <label for="name" class="block text-sm font-medium text-gray-300">Name <span class="text-red-500 font-bold">*</span></label>
                        <input type="text" name="name" id="name" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" required>
                    </div>

                    <div class="col-span-full md:col-span-4">
                        <label for="link" class="block text-sm font-medium text-gray-300">Link <span class="text-red-500 font-bold">*</span></label>
                        <input type="text" name="link" id="link" class="text-gray-300 bg-gray-700 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-600 rounded-md" required>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        $("#button-edit-download-{{ $download->id }}").click(function() {
           $("#modal-edit-download-{{ $download->id }}").fadeIn(100);
        });

        $("#modal-edit-cancel-download-{{ $download->id }}, #overlay-edit-download-{{ $download->id }}").click(function() {
            $("#modal-edit-download-{{ $download->id }}").fadeOut(100);
        });
        @endforeach
        @endcan
