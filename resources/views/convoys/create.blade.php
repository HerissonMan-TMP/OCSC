        ...
        <form action="{{ route('staff.convoys.store') }}" method="POST">
            ...
            <div class="grid grid-cols-10 gap-6">
                ...
                <div class="col-span-full md:col-span-5">
                    ...
                    <input type="text" name="title" id="title" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('title') }}" required>
                    @error('title')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <input type="text" name="location" id="location" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('location') }}" required>
                    @error('location')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-2">
                    ...
                    <input type="text" name="distance" id="distance" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('distance') }}">
                    @error('distance')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <input type="text" name="destination" id="destination" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('destination') }}" required>
                    @error('destination')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-2">
                    ...
                    <input type="text" name="server" id="server" class="text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('server') }}" required>
                    @error('server')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
                ...
                <div class="col-span-full md:col-span-2">
                    ...
                    <input type="datetime-local" name="meetup_date" id="meetup_date" class="flatpickr text-gray-300 bg-gray-800 mt-1 focus:ring-primary-dark focus:border-primary-dark block w-full shadow-sm md:text-sm border-gray-700 rounded-md" value="{{ old('meetup_date') }}" required>
                    @error('meetup_date')
                    <span class="pt-2 text-sm text-red-500">
                        {{ $message }}
                    </span>
